...
export function PropertyInventory({ properties }: { properties: CmsPropertyRecord[] }) {
  ...
  return (
    <div className="grid gap-5">
      ...
      <p className="text-xs text-muted-foreground">Production records are stored in Supabase unless the optional headless WordPress adapter is enabled. Archived records are removed from public listings.</p>
    </div>
  );
}
